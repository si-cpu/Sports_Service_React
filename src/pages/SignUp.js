    ...
    const checkNicknameDuplicate = async () => {
        ...
        try {
            const response = await axios.get(
                `http://localhost:8181/member/valid_id?nick_name=${nickname}`
            );
    ...
    return (
        <div className="signup-container">
            <div className="signup-box">
                <h1 className="signup-title">Sports Service Sign-Up</h1>
                <p className="signup-second-title">회원가입을 통해 더 다양한 서비스를 만나보세요</p>
